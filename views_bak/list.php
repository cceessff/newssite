...
<head>
    ...
    <link rel="canonical" href="http://ecms185.99yuanma.net:8889/">
...
<header class="ulooezdb">
    <div class="cezbysxy">
        <div class="gwvxeiiq xuqlzltb"><a href="http://ecms185.99yuanma.net:8889/">
                <mip-img src="/static/img/logo.png" alt="<?php echo $site_title; ?>"
                         class="mip-element mip-layout-container mip-img-loaded" mip-firstscreen-element=""></mip-img>
            </a></div>
                    ...
                    <nav id="bs-navbar" class="navbar-collapse collapse navbar navbar-static-top">
                        <ul class="ezjzdybw navbar-nav navbar-right">
                            ...
                            <?php foreach ($nav as $nav_url => $nav_name): ?>
                                <li class="">
                                    <a href="<?php echo $site_url . 'category/' . $nav_url; ?>"><?php echo $nav_name; ?></a>
                                </li>
                            <?php endforeach; ?>
    ...
    <div class="gwvxeiiq vgllukiw">
        ...
        <?php foreach ($news_list as $item):?>
            <div class="tkeumwkh">
                <ul>
                    <li>
                        <h3><a href="<?php echo $site_url."content/".$item['article_id'].".html";?>"><?php echo $item['title'];?></a></h3>
                    </li>
                    <li class="qbyszjpf"><i class="icon-time"></i>
                        <time><?php echo date("Y-m-d H:i:s",$item['publish_time']);?></time>
                    </li>
                    <li class="qbyszjpf">
                        <?php echo $item['intro'];?>
                    </li>
            ...
            <?php foreach ($hot_news as $hot_item):?>
                <div class="tkeumwkh">
                    <ul>
                        ...
                        <li class="qbyszjpf"><i class="icon-time"></i>
                            <time><?php echo date("Y-m-d",$hot_item['publish_time']);?></time>
                        </li>
                        <li class="qbyszjpf">
...
<footer class="ravrlakj">
    <ul>
        ...
        <li><a href="<?php echo $site_url;?>"><?php echo $site_name;?></a> 版权所有</li>
    </ul>
</footer>
...
<mip-fixed id="mip-page-loading-wrapper" class="mip-page-loading-wrapper mip-element" mipdata-fixedidx="Fixed5"
    ...
    <div class="mip-shell-header"><span mip-header-btn="" class="back-button"><svg t="1530857979993" class="icon"
        ...
        <div class="mip-shell-header-logo-title"><img class="mip-shell-header-logo"
                                                      src="<?php echo $site_url.$category;?>"><span
